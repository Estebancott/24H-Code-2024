-- fix me then play
    ...
    -- pl.dy = pl.dy + pl.ddy  -- Comment out this line to remove gravity
    pl.dy = pl.dy * 0.95
    ...
    function collide(a1, a2)
     if (a1==a2) then return end -- pas de deplacement?
     local dx = a1.x - a2.x
     local dy = a1.y - a2.y
    ...
    -- map and actors
    cam_x = mid(0,player.x-64,1024-128)
    c_y = 84
    camera (cam_x,c_y) -- corrected here
    pal(12,0)	
